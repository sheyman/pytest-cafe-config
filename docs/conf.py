# -*- coding: utf-8 -*-
#
# pytest-cafe-config documentation build configuration file, created by
...
project = u'pytest-cafe-config'
copyright = u'2015, Daryl Walleck'
author = u'Daryl Walleck'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-cafe-config Documentation',
     [author], 1)
]
